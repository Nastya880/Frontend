...
function two(callback) {
    if (callback) return callback(2);
    else return 2;
}
function three(callback) {
    if (callback) return callback(3);
    else return 3;
}
function four(callback) {
    if (callback) return callback(4);
    else return 4;
}
function five(callback) {
    if (callback) return callback(5);
    else return 5;
}
function six(callback) {
    if (callback) return callback(6);
    else return 6;
}
function seven(callback) {
    if (callback) return callback(7);
    else return 7;
}
function eight(callback) {
    if (callback) return callback(8);
    else return 8;
}
function nine(callback) {
    if (callback) return callback(9);
    else return 9;
}
...
console.log(one(mult(three(sum(four()))))); // В итоге вернется 7
